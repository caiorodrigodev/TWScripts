...
function fnTranslate(id) {
    var translation = {
        ...
        pt: [
            'Treino Completo de Nukers',
            'Treino Completo de Defesa',
            'Outros Nobres',
            'Nukers Completos',
            'Nukers 3/4',
            'Nukers 1/2',
            ...
            'Exércitos Nobres',
            'Exércitos Ofensivos',
            'Exércitos Defensivos',
            'Exércitos de Exploradores',
            'Outros Exércitos',
            'Unidades Ofensivas',
            'Unidades Defensivas',
            'Outras Unidades',
...
function fnHasArchers() {
    return parseInt(worldConfig.find('game archer').text() || '0', 10) > 0;
}

function fnHasMilitia() {
    return unitConfig.find('militia').length > 0;
}
